...
The Events API can be used to view and delete events generated by policy alerts in CloudWisdom. Responses include details about elements and policies associated to the events found. 
